...
* Whether your contribution is for a bug fix or a feature request, **create an [Issue](https://github.com/intelsdi-x/snap-plugin-collector-openvswitch/issues)** and let us know what you are thinking.
...
* Clone the fork to `$GOPATH/src/github.com/intelsdi-x/`:
  ...
  $ git clone https://github.com/intelsdi-x/snap-plugin-collector-openvswitch.git
  ```
